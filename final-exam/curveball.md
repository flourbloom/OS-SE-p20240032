# LIVE MODIFICATION TASKS — CHEA SEAVHONG (p20240032)
...
| **D** | Add a **per-buyer purchase cap** to your purchase script (`buy_…`) — reject any single order above it; re-run `swarm` and show the locked result respects the cap and stays consistent. | **cap = 7** |
